 ...
 */
public class GetOrgParSubActionCommandImpl implements TSServiceCommandImpl
{
	@Override
		...
		TSServiceCommand command) throws TSServiceException
	{
		...
		if (model != null)
		{
			new GetOrgParSubAction(drawingView, actionName)
			{
				@Override
				protected void showNoResults()
				{
					GetOrgParSubActionCommandImpl.this.result =
						"No results found.";
				}
			}.onAction();
		}
