 ...
 */
public class GetALTPersonActionCommandImpl implements TSServiceCommandImpl
{
	@Override
		...
		TSServiceCommand command) throws TSServiceException
	{
		...
		if (model != null)
		{
			new GetALTPersonAction(drawingView, actionName)
			{
				@Override
				protected void showNoResults()
				{
					GetALTPersonActionCommandImpl.this.result =
						"No results found.";
				}
			}.onAction();
		}
